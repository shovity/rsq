    ...
    this.redisClient.incr(this.QUEUE_SERIAL, (err, reply) => {
      ...
      this.streams.forEach(stream => {
        let streams = message.stream
          ...
          return done(new Error('message.stream must be string or array of string'))
        }
      ...
      if (notMatchAnyStream) {
        return done(new Error('message not match any stream, message was lost'))
      }
